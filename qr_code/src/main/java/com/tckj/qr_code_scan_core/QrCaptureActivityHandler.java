...
import com.tckj.qr_code.QrCodeScanActivity;

import java.util.Collection;

/**
 * This class handles all the messaging which comprises the state machine for activity_qr_code_scan.
 *
...
public final class QrCaptureActivityHandler extends Handler {
  ...
  public QrCaptureActivityHandler(QrCodeScanActivity activity,
                                  Collection<BarcodeFormat> decodeFormats,
                                  CameraManager cameraManager) {
    this.activity = activity;
    decodeThread = new QrDecodeThread(activity, decodeFormats,
