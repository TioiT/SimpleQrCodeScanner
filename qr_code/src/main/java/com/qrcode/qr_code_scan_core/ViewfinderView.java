...
public final class ViewfinderView extends View {
  ...
  public ViewfinderView(Context context, AttributeSet attrs) {
    ...
    mFrameColor = resources.getColor(com.qrcode.qr_code.R.color.qr_code_finder_frame);
...
//    lastPossibleResultPoints = null;
  ...
  private void initDefaultValue(Context context) {
    ...
    FrameLayout frameLayout = relativeLayout.findViewById(com.qrcode.qr_code.R.id.qr_code_fl_scanner);
    mFrameRect = new Rect();
...
//    float mAngleThick = (float) 6.0;
  ...
  private void drawText(Canvas canvas, Rect rect) {
    int margin = 40;
    paint.setColor(mFrameColor);
    paint.setTextSize(getResources().getDimension(com.qrcode.qr_code.R.dimen.qr_code_text_size_13sp));
    String text = getResources().getString(com.qrcode.qr_code.R.string.qr_code_auto_scan_notification);
